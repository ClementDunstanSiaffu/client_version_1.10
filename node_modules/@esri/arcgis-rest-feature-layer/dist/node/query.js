...
function getFeature(requestOptions) {
    var url = arcgis_rest_request_1.cleanUrl(requestOptions.url) + "/" + requestOptions.id;
...
function queryFeatures(requestOptions) {
    var queryOptions = arcgis_rest_request_1.appendCustomParams(requestOptions, [
        "where",
        "objectIds",
        "relationParam",
        "time",
    ...
    return arcgis_rest_request_1.request(arcgis_rest_request_1.cleanUrl(requestOptions.url) + "/query", queryOptions);
}
