    ...
    ***************************************************************************** */
    ...
    function addItemPart(requestOptions) {
        ...
        return determineOwner(requestOptions).then(function (owner) {
            ...
            var options = arcgisRestRequest.appendCustomParams(requestOptions, ["file"], { params: __assign({}, requestOptions.params) });
            return arcgisRestRequest.request(url, options);
        });
    }
    /**
    ...
    function createOrgNotification(options) {
        ...
        var promises = batches.map(function (batch) { return _sendSafeRequest$2(url, batch); });
    ...
    function _generateBatchRequests$1(options) {
        ...
        return userBatches.map(function (users) { return _generateRequestOptions$2(users, options); });
    }
    /**
     * @private
     */
    function _generateRequestOptions$2(users, baseOptions) {
        var requestOptions = Object.assign({}, baseOptions);
