...
function updateUser(requestOptions) {
    ...
    var updateUrl = get_portal_url_1.getPortalUrl(requestOptions) + "/community/users/" + encodeURIComponent(username) + "/update";
    // mixin custom params and the user information, then drop the user info
    requestOptions.params = tslib_1.__assign(tslib_1.__assign({}, requestOptions.user), requestOptions.params);
    delete requestOptions.user;
    // send the request
    return arcgis_rest_request_1.request(updateUrl, requestOptions);
}
