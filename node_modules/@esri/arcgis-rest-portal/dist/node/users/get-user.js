...
function getUser(requestOptions) {
    ...
    if (typeof requestOptions === "string") {
        ...
        url = get_portal_url_1.getPortalUrl(requestOptions) + "/community/users/" + encodeURIComponent(username);
        options = tslib_1.__assign(tslib_1.__assign({}, requestOptions), options);
    }
    // send the request
