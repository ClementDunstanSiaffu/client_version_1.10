...
function addItemData(requestOptions) {
    ...
    delete options.id;
    delete options.data;
    return update_1.updateItem(options);
}
...
function addItemRelationship(requestOptions) {
    return helpers_1.determineOwner(requestOptions).then(function (owner) {
        var url = get_portal_url_1.getPortalUrl(requestOptions) + "/content/users/" + owner + "/addRelationship";
...
function addItemResource(requestOptions) {
    return helpers_1.determineOwner(requestOptions).then(function (owner) {
        var url = get_portal_url_1.getPortalUrl(requestOptions) + "/content/users/" + owner + "/items/" + requestOptions.id + "/addResources";
        requestOptions.params = tslib_1.__assign({ file: requestOptions.resource, fileName: requestOptions.name, resourcesPrefix: requestOptions.prefix, text: requestOptions.content, access: requestOptions.private ? "private" : "inherit" }, requestOptions.params);
