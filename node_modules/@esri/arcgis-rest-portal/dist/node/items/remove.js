...
function removeItemRelationship(requestOptions) {
    return helpers_1.determineOwner(requestOptions).then(function (owner) {
        var url = get_portal_url_1.getPortalUrl(requestOptions) + "/content/users/" + owner + "/deleteRelationship";
...
function removeItemResource(requestOptions) {
    return helpers_1.determineOwner(requestOptions).then(function (owner) {
        ...
        requestOptions.params = tslib_1.__assign(tslib_1.__assign({}, requestOptions.params), { resource: requestOptions.resource });
