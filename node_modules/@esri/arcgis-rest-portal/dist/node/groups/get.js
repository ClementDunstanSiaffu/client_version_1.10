...
function getGroup(id, requestOptions) {
    var url = get_portal_url_1.getPortalUrl(requestOptions) + "/community/groups/" + id;
...
function getGroupCategorySchema(id, requestOptions) {
    var url = get_portal_url_1.getPortalUrl(requestOptions) + "/community/groups/" + id + "/categorySchema";
    // default to a GET request
    var options = tslib_1.__assign({ httpMethod: "GET" }, requestOptions);
    return arcgis_rest_request_1.request(url, options);
}
...
function getGroupContent(id, requestOptions) {
    var url = get_portal_url_1.getPortalUrl(requestOptions) + "/content/groups/" + id;
    // default to a GET request
    var options = tslib_1.__assign(tslib_1.__assign({ httpMethod: "GET" }, { params: { start: 1, num: 100 } }), requestOptions);
...
function getGroupUsers(id, requestOptions) {
    var url = get_portal_url_1.getPortalUrl(requestOptions) + "/community/groups/" + id + "/users";
    // default to a GET request
    var options = tslib_1.__assign({ httpMethod: "GET" }, requestOptions);
    return arcgis_rest_request_1.request(url, options);
}
...
function searchGroupUsers(id, searchOptions) {
    var url = get_portal_url_1.getPortalUrl(searchOptions) + "/community/groups/" + id + "/userlist";
    var options = arcgis_rest_request_1.appendCustomParams(searchOptions || {}, ["name", "num", "start", "sortField", "sortOrder", "joined", "memberType"], {
        httpMethod: "GET"
    });
    return arcgis_rest_request_1.request(url, options);
}
