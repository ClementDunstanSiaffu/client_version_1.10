...
function protectGroup(requestOptions) {
    var url = get_portal_url_1.getPortalUrl(requestOptions) + "/community/groups/" + requestOptions.id + "/protect";
...
function unprotectGroup(requestOptions) {
    var url = get_portal_url_1.getPortalUrl(requestOptions) + "/community/groups/" + requestOptions.id + "/unprotect";
    return arcgis_rest_request_1.request(url, requestOptions);
}
