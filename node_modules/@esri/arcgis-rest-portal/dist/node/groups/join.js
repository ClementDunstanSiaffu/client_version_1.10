...
function joinGroup(requestOptions) {
    var url = get_portal_url_1.getPortalUrl(requestOptions) + "/community/groups/" + requestOptions.id + "/join";
...
function leaveGroup(requestOptions) {
    var url = get_portal_url_1.getPortalUrl(requestOptions) + "/community/groups/" + requestOptions.id + "/leave";
    return arcgis_rest_request_1.request(url, requestOptions);
}
