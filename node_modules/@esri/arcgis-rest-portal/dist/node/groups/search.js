...
var generic_search_1 = require("../util/generic-search");
/**
 * ```js
...
function searchGroups(search) {
    return generic_search_1.genericSearch(search, "group");
}
...
function searchGroupContent(options) {
    return generic_search_1.genericSearch(options, "groupContent");
}
