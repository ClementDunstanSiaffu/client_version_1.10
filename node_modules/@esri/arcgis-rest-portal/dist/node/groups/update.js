...
function updateGroup(requestOptions) {
    var url = get_portal_url_1.getPortalUrl(requestOptions) + "/community/groups/" + requestOptions.group.id + "/update";
    requestOptions.params = tslib_1.__assign(tslib_1.__assign({}, requestOptions.params), requestOptions.group);
