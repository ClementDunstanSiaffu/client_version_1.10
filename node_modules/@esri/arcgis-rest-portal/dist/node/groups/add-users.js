...
function addGroupUsers(requestOptions) {
    ...
    var batchRequestOptions = tslib_1.__spreadArrays(_prepareRequests("users", requestOptions.users, baseOptions), _prepareRequests("admins", requestOptions.admins, baseOptions));
...
function _generateRequestOptions(type, usernames, baseOptions) {
    ...
    return Object.assign({}, baseOptions, (_a = {},
        _a[type] = usernames,
        _a.params = tslib_1.__assign(tslib_1.__assign({}, baseOptions.params), (_b = {}, _b[type] = usernames, _b)),
        _a));
}
