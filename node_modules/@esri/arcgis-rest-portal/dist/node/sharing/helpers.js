...
function getSharingUrl(requestOptions) {
    ...
    return get_portal_url_1.getPortalUrl(requestOptions) + "/content/users/" + encodeURIComponent(owner) + "/items/" + requestOptions.id + "/share";
}
...
function getUserMembership(requestOptions) {
    // fetch the group...
    return get_1.getGroup(requestOptions.groupId, requestOptions)
        .then(function (group) {
