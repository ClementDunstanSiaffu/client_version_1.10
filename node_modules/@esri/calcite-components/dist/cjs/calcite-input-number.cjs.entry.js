...
const label = require('./label-e24023c6.js');
const form = require('./form-4d1ef8c2.js');
const locale = require('./locale-2d8feb15.js');
const key = require('./key-017aa5b0.js');
const math = require('./math-7fe3e64d.js');
const observers = require('./observers-aa7367df.js');
...
const InputNumber = class {
  constructor(hostRef) {
    ...
    this.nudgeButtonPointerUpAndOutHandler = () => {
      window.clearInterval(this.nudgeNumberValueIntervalId);
    };
    ...
    this.setPreviousEmittedNumberValue = (newPreviousEmittedValue) => {
      this.previousEmittedValue = locale.isValidNumber(newPreviousEmittedValue)
        ? newPreviousEmittedValue
        : "";
    };
    this.setPreviousNumberValue = (newPreviousValue) => {
      this.previousValue = locale.isValidNumber(newPreviousValue) ? newPreviousValue : "";
    };
    this.setNumberValue = ({ committing = false, nativeEvent, origin, previousValue, value }) => {
      const previousLocalizedValue = locale.localizeNumberString(this.previousValue, this.locale, this.groupSeparator, this.numberingSystem);
      const sanitizedValue = locale.sanitizeNumberString(value);
      const newValue = value && !sanitizedValue
        ? locale.isValidNumber(this.previousValue)
          ? this.previousValue
          : ""
        : sanitizedValue;
      const newLocalizedValue = locale.localizeNumberString(newValue, this.locale, this.groupSeparator, this.numberingSystem);
  ...
  render() {
    ...
    const inputClearButton = (index.h("button", { "aria-label": this.intlClear || TEXT.clear, class: CSS.clearButton, disabled: this.disabled || this.readOnly, onClick: this.clearInputValue, tabIndex: this.disabled ? -1 : 0, type: "button" }, index.h("calcite-icon", { icon: "x", scale: "s" })));
    ...
    const numberButtonsHorizontalUp = (index.h("button", { class: {
      ...
      }, "data-adjustment": "up", disabled: this.disabled || this.readOnly, onPointerDown: this.nudgeButtonPointerDownHandler, onPointerOut: this.nudgeButtonPointerUpAndOutHandler, onPointerUp: this.nudgeButtonPointerUpAndOutHandler, tabIndex: -1, type: "button" }, index.h("calcite-icon", { icon: "chevron-up", scale: "s" })));
    const numberButtonsHorizontalDown = (index.h("button", { class: {
        [CSS.numberButtonItem]: true,
        [CSS.buttonItemHorizontal]: isHorizontalNumberButton
      }, "data-adjustment": "down", disabled: this.disabled || this.readOnly, onPointerDown: this.nudgeButtonPointerDownHandler, onPointerOut: this.nudgeButtonPointerUpAndOutHandler, onPointerUp: this.nudgeButtonPointerUpAndOutHandler, tabIndex: -1, type: "button" }, index.h("calcite-icon", { icon: "chevron-down", scale: "s" })));
    ...
    const childEl = (index.h("input", { "aria-label": label.getLabelText(this), autofocus: this.autofocus ? true : null, defaultValue: this.defaultValue, disabled: this.disabled ? true : null, enterKeyHint: this.el.enterKeyHint, inputMode: this.el.inputMode, key: "localized-input", maxLength: this.maxLength, minLength: this.minLength, name: undefined, onBlur: this.inputNumberBlurHandler, onFocus: this.inputNumberFocusHandler, onInput: this.inputNumberInputHandler, onKeyDown: this.inputNumberKeyDownHandler, onKeyUp: this.inputNumberKeyUpHandler, placeholder: this.placeholder || "", readOnly: this.readOnly, ref: this.setChildNumberElRef, type: "text", value: this.localizedValue }));
    return (index.h(index.Host, { onClick: this.inputNumberFocusHandler, onKeyDown: this.keyDownHandler }, index.h("div", { class: { [CSS.inputWrapper]: true, [dom.CSS_UTILITY.rtl]: dir === "rtl" } }, this.numberButtonType === "horizontal" && !this.readOnly
