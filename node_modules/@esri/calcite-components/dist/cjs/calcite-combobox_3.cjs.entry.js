...
const debounce = require('./debounce-d2139fc6.js');
const forIn = require('./forIn-9ac96598.js');
const popper = require('./popper-f29f9a3b.js');
...
const Combobox = class {
  constructor(hostRef) {
    ...
    this.calciteComboboxBeforeClose = index.createEvent(this, "calciteComboboxBeforeClose", 7);
    this.calciteComboboxClose = index.createEvent(this, "calciteComboboxClose", 7);
    this.calciteComboboxBeforeOpen = index.createEvent(this, "calciteComboboxBeforeOpen", 7);
  ...
  renderPopperContainer() {
    ...
    const classes = {
      ...
      [popper.CSS.animationActive]: open || active
    };
    return (index.h("div", { "aria-hidden": "true", class: { "popper-container": true, "popper-container--active": open || active }, ref: setMenuEl }, index.h("div", { class: classes, onTransitionEnd: this.transitionEnd, ref: setListContainerEl }, index.h("ul", { class: { list: true, "list--hide": !(open || active) } }, index.h("slot", null)))));
  }
  renderIconStart() {
    var _a;
    ...
    return (selectionMode === "single" &&
      needsIcon &&
      ((selectedItem === null || selectedItem === void 0 ? void 0 : selectedItem.icon) || placeholderIcon) && (index.h("span", { class: "icon-start" }, index.h("calcite-icon", { class: "selected-icon", icon: (_a = selectedItem === null || selectedItem === void 0 ? void 0 : selectedItem.icon) !== null && _a !== void 0 ? _a : placeholderIcon, scale: "s" }))));
  }
  renderIconEnd() {
  ...
  render() {
    ...
    return (index.h(index.Host, { onKeyDown: this.keydownHandler }, index.h("div", { "aria-autocomplete": "list", "aria-expanded": dom.toAriaBoolean(open || active), "aria-haspopup": "listbox", "aria-labelledby": `${labelUidPrefix}${guid}`, "aria-owns": `${listboxUidPrefix}${guid}`, class: {
        wrapper: true,
