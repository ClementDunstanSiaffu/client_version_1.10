...
const resources = require('./resources-9aaa6e0a.js');
...
require('./locale-2d8feb15.js');
require('./key-017aa5b0.js');
...
const DatePickerDay = class {
  constructor(hostRef) {
    ...
    this.calciteInternalDayHover = index.createEvent(this, "calciteInternalDayHover", 7);
...
const DatePickerMonth = class {
  constructor(hostRef) {
    ...
    this.calciteInternalDatePickerHover = index.createEvent(this, "calciteInternalDatePickerHover", 7);
    this.calciteDatePickerActiveDateChange = index.createEvent(this, "calciteDatePickerActiveDateChange", 7);
    this.calciteInternalDatePickerMouseOut = index.createEvent(this, "calciteInternalDatePickerMouseOut", 7);
  ...
  renderDateDay(active, day, date, currentMonth, ref) {
    ...
    return (index.h("calcite-date-picker-day", { active: active, class: {
      ...
      }, currentMonth: currentMonth, day: day, disabled: !resources.inRange(date, this.min, this.max), endOfRange: this.isEndOfRange(date), highlighted: this.betweenSelectedRange(date), key: date.toDateString(), localeData: this.localeData, onCalciteDaySelect: this.daySelect, onCalciteInternalDayHover: this.dayHover, range: !!this.startDate && !!this.endDate && !resources.sameDate(this.startDate, this.endDate), rangeHover: this.isRangeHover(date), ref: (el) => {
...
const DatePickerMonthHeader = class {
  ...
  formatCalendarYear(year) {
    ...
    return resources.localizeNumber(resources.parseNumber(year, localeData) + yearOffset, localeData);
  }
