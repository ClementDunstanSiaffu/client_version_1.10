...
const Input = class {
  constructor(hostRef) {
    ...
    this.calciteInternalInputFocus = index.createEvent(this, "calciteInternalInputFocus", 7);
    this.calciteInternalInputBlur = index.createEvent(this, "calciteInternalInputBlur", 7);
    ...
    this.setValue = ({ committing = false, nativeEvent, origin, previousValue, value }) => {
      const previousLocalizedValue = this.type === "number"
        ? locale.localizeNumberString(this.previousValue, this.locale, this.groupSeparator, this.numberingSystem)
        : "";
      const sanitizedValue = this.type === "number" ? locale.sanitizeNumberString(value) : value;
      ...
      const newLocalizedValue = this.type === "number"
        ? locale.localizeNumberString(newValue, this.locale, this.groupSeparator, this.numberingSystem)
        : "";
  ...
  render() {
    ...
    const childEl = this.type !== "number"
      ...
      : null;
    return (index.h(index.Host, { onClick: this.inputFocusHandler, onKeyDown: this.keyDownHandler }, index.h("div", { class: { [CSS.inputWrapper]: true, [dom.CSS_UTILITY.rtl]: dir === "rtl" } }, this.type === "number" && this.numberButtonType === "horizontal" && !this.readOnly
