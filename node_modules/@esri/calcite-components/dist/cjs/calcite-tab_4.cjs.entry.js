...
const Tab = class {
  constructor(hostRef) {
    ...
    this.calciteInternalTabRegister = index.createEvent(this, "calciteInternalTabRegister", 7);
    /**
     * Show this tab
     */
    this.active = false;
  ...
  render() {
    ...
    return (index.h(index.Host, { "aria-expanded": dom.toAriaBoolean(this.active), "aria-labelledby": this.labeledBy, id: id, role: "tabpanel" }, index.h("section", null, index.h("slot", null))));
  }
  connectedCallback() {
...
const TabTitle = class {
  constructor(hostRef) {
    ...
    this.calciteInternalTabsFocusNext = index.createEvent(this, "calciteInternalTabsFocusNext", 7);
    this.calciteInternalTabsFocusPrevious = index.createEvent(this, "calciteInternalTabsFocusPrevious", 7);
    this.calciteInternalTabTitleRegister = index.createEvent(this, "calciteInternalTabTitleRegister", 7);
    //--------------------------------------------------------------------------
    //
    //  Properties
    //
  ...
  render() {
    ...
    return (index.h(index.Host, { "aria-controls": this.controls, "aria-expanded": dom.toAriaBoolean(this.active), id: id, role: "tab" }, index.h("a", { class: {
        container: true,
        "container--has-text": this.hasText
      } }, this.iconStart ? iconStartEl : null, index.h("slot", null), this.iconEnd ? iconEndEl : null)));
  }
