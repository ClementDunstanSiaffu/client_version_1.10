...
const Dropdown = class {
  constructor(hostRef) {
    ...
    this.calciteDropdownBeforeOpen = index.createEvent(this, "calciteDropdownBeforeOpen", 7);
    this.calciteDropdownOpen = index.createEvent(this, "calciteDropdownOpen", 7);
    this.calciteDropdownBeforeClose = index.createEvent(this, "calciteDropdownBeforeClose", 7);
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: "calcite-dropdown-trigger-container", onClick: this.openCalciteDropdown, onKeyDown: this.keyDownHandler, ref: this.setReferenceEl }, index.h("slot", { "aria-expanded": dom.toAriaBoolean(active || open), "aria-haspopup": "true", name: SLOTS.dropdownTrigger, onSlotchange: this.updateTriggers })), index.h("div", { "aria-hidden": dom.toAriaBoolean(!(active || open)), class: "calcite-dropdown-wrapper", ref: this.setMenuEl }, index.h("div", { class: {
        ["calcite-dropdown-content"]: true,
        [popper.CSS.animation]: true,
        [popper.CSS.animationActive]: active || open
      }, onTransitionEnd: this.transitionEnd, ref: this.setScrollerEl }, index.h("div", { hidden: !(open || active) }, index.h("slot", { onSlotchange: this.updateGroups }))))));
  }
  //--------------------------------------------------------------------------
  //
  //  Public Methods
...
const DropdownGroup = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.calciteInternalDropdownItemChange = index.createEvent(this, "calciteInternalDropdownItemChange", 7);
    /**
...
const DropdownItem = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.calciteInternalDropdownItemSelect = index.createEvent(this, "calciteInternalDropdownItemSelect", 7);
    this.calciteInternalDropdownItemKeyEvent = index.createEvent(this, "calciteInternalDropdownItemKeyEvent", 7);
    this.calciteInternalDropdownCloseRequest = index.createEvent(this, "calciteInternalDropdownCloseRequest", 7);
    //--------------------------------------------------------------------------
    //
    //  Public Properties
    //
  ...
  render() {
    ...
    const itemRole = this.href
      ...
      : this.selectionMode === "single"
        ...
        : this.selectionMode === "multi"
          ? "menuitemcheckbox"
          : "menuitem";
    const itemAria = this.selectionMode !== "none" ? dom.toAriaBoolean(this.active) : null;
    return (index.h(index.Host, { "aria-checked": itemAria, role: itemRole, tabindex: "0" }, index.h("div", { class: {
      ...
      } }, this.selectionMode !== "none" ? (index.h("calcite-icon", { class: "dropdown-item-icon", icon: this.selectionMode === "multi" ? "check" : "bullet-point", scale: "s" })) : null, contentEl)));
  }
  //--------------------------------------------------------------------------
  //
  //  Event Listeners
