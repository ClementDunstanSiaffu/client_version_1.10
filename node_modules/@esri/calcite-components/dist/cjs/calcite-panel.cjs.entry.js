...
const Heading = require('./Heading-f792c5a6.js');
const resources = require('./resources-a7f0af25.js');
...
const Panel = class {
  constructor(hostRef) {
    ...
    this.calcitePanelDismiss = index.createEvent(this, "calcitePanelDismiss", 7);
  ...
  renderHeaderContent() {
    ...
    const descriptionNode = description || summary ? index.h("span", { class: CSS.description }, description || summary) : null;
    return headingNode || descriptionNode ? (index.h("div", { class: CSS.headerContent, key: "header-content" }, headingNode, descriptionNode)) : null;
  }
  /**
  ...
  renderHeaderActionsEnd() {
    ...
    const dismissibleNode = closable || dismissible ? (index.h("calcite-action", { "aria-label": text, icon: ICONS.close, onClick: dismiss, ref: this.setDismissRef, text: text })) : null;
  ...
  renderContent() {
    ...
    return hasFab ? (index.h("div", { class: { [CSS.contentWrapper]: true, [CSS.contentHeight]: true }, key: contentWrapperKey, onScroll: this.panelScrollHandler, ref: this.setPanelScrollEl }, index.h("section", { class: CSS.contentContainer }, defaultSlotNode), this.renderFab())) : (index.h("section", { class: { [CSS.contentWrapper]: true, [CSS.contentContainer]: true }, key: contentWrapperKey, onScroll: this.panelScrollHandler, ref: this.setPanelScrollEl }, defaultSlotNode));
  }
  renderFab() {
    return (index.h("div", { class: CSS.fabContainer }, index.h("slot", { name: SLOTS.fab })));
  }
  render() {
    const { dismissed, dismissible, loading, panelKeyDownHandler, closed, closable } = this;
    const panelNode = (index.h("article", { "aria-busy": dom.toAriaBoolean(loading), class: CSS.container, hidden: (closable || dismissible) && (closed || dismissed), onKeyDown: panelKeyDownHandler, ref: this.setContainerRef, tabIndex: closable || dismissible ? 0 : -1 }, this.renderHeaderNode(), this.renderContent(), this.renderFooterNode()));
