...
const Chip = class {
  ...
  render() {
    ...
    return (index.h("div", { class: "container" }, this.renderChipImage(), this.icon ? iconEl : null, index.h("span", { class: CSS.title, id: this.guid }, index.h("slot", null)), this.closable || this.dismissible ? closeButton : null));
  }
