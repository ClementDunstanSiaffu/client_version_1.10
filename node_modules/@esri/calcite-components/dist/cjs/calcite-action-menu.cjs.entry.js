...
const array = require('./array-b72d7dd3.js');
...
const ActionMenu = class {
  ...
  renderMenuButton() {
    ...
    const menuButtonSlot = (index.h("slot", { name: resources.SLOTS.trigger }, index.h("calcite-action", { class: resources.CSS.defaultTrigger, icon: resources.ICONS.menu, ref: this.setDefaultMenuButtonEl, scale: scale, text: label, textEnabled: expanded })));
