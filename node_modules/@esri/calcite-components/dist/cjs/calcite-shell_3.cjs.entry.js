...
const Shell = class {
  ...
  renderContent() {
    ...
    const centerRowSlotNode = index.h("slot", { key: "center-row-slot", name: SLOTS$2.centerRow });
  ...
  renderMain() {
    ...
    return (index.h("div", { class: mainClasses }, index.h("slot", { name: SLOTS$2.primaryPanel }), this.renderContent(), index.h("slot", { name: SLOTS$2.contextualPanel })));
  }
  render() {
