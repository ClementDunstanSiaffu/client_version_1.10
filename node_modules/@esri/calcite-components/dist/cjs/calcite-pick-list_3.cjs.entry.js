...
const resources = require('./resources-0c0019fb.js');
...
require('./array-b72d7dd3.js');
require('./debounce-d2139fc6.js');
...
const PickListItem = class {
  constructor(hostRef) {
    ...
    this.calciteInternalListItemPropsChange = index.createEvent(this, "calciteInternalListItemPropsChange", 7);
    this.calciteInternalListItemValueChange = index.createEvent(this, "calciteInternalListItemValueChange", 7);
    /**
     * When true, interaction is prevented and the component is displayed with lower opacity.
     */
    this.disabled = false;
