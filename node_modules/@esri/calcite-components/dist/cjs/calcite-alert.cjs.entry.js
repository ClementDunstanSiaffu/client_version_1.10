...
const Alert = class {
  constructor(hostRef) {
    ...
    this.calciteAlertBeforeClose = index.createEvent(this, "calciteAlertBeforeClose", 7);
    this.calciteAlertClose = index.createEvent(this, "calciteAlertClose", 7);
    this.calciteAlertBeforeOpen = index.createEvent(this, "calciteAlertBeforeOpen", 7);
    this.calciteAlertOpen = index.createEvent(this, "calciteAlertOpen", 7);
    this.calciteInternalAlertSync = index.createEvent(this, "calciteInternalAlertSync", 7);
    this.calciteInternalAlertRegister = index.createEvent(this, "calciteInternalAlertRegister", 7);
    //--------------------------------------------------------------------------
    //
    //  Properties
    //
