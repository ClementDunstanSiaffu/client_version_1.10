...
:host(:hover:not([disabled]):not([active])) .container .stepper-item-heading, 
:host(:focus:not([disabled]):not([active])) .container .stepper-item-heading {
  color: var(--calcite-ui-text-1);
}
:host(:hover:not([disabled]):not([active])) .container .stepper-item-description, 
:host(:focus:not([disabled]):not([active])) .container .stepper-item-description {
  color: var(--calcite-ui-text-2);
}
...
:host([active]) .container .stepper-item-heading {
  color: var(--calcite-ui-text-1);
}
:host([active]) .container .stepper-item-description {
  color: var(--calcite-ui-text-2);
}
