...
export class Input {
  ...
  render() {
    ...
    const numberButtonsHorizontalUp = (h("button", { class: {
      ...
      }, "data-adjustment": "up", disabled: this.disabled || this.readOnly, onPointerDown: this.numberButtonPointerDownHandler, onPointerOut: this.numberButtonPointerUpAndOutHandler, onPointerUp: this.numberButtonPointerUpAndOutHandler, tabIndex: -1, type: "button" },
      h("calcite-icon", { icon: "chevron-up", scale: "s" })));
    const numberButtonsHorizontalDown = (h("button", { class: {
        [CSS.numberButtonItem]: true,
        [CSS.buttonItemHorizontal]: isHorizontalNumberButton
      }, "data-adjustment": "down", disabled: this.disabled || this.readOnly, onPointerDown: this.numberButtonPointerDownHandler, onPointerOut: this.numberButtonPointerUpAndOutHandler, onPointerUp: this.numberButtonPointerUpAndOutHandler, tabIndex: -1, type: "button" },
  ...
  static get properties() { return {
    ...
    "groupSeparator": {
      ...
      "docs": {
        "tags": [],
        "text": "When true, number values are displayed with the locale's group separator."
      },
    ...
    "iconFlipRtl": {
      ...
      "docs": {
        "tags": [],
        "text": "When true, the icon is flipped in RTL."
      },
    ...
    "numberingSystem": {
      ...
      "docs": {
        "tags": [{
            "name": "mdn",
            "text": "[numberingSystem](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/Locale/numberingSystem)"
          }],
    ...
    "readOnly": {
      ...
      "docs": {
        ...
        "text": "When true, the value cannot be modified."
      },
      "attribute": "read-only",
      "reflect": false,
      "defaultValue": "false"
