...
export class Tooltip {
  ...
  render() {
    ...
    return (h(Host, { "aria-hidden": toAriaBoolean(hidden), "aria-label": label, "aria-live": "polite", "calcite-hydrated-hidden": hidden, id: this.getId(), role: "tooltip" },
      h("div", { class: {
  ...
  static get properties() { return {
    ...
    "overlayPositioning": {
      ...
      "docs": {
        "tags": [],
        "text": "Describes the positioning type to use for the overlaid content. If the `referenceElement` is in a fixed container, use the \"fixed\" value."
      },
    ...
    "referenceElement": {
      ...
      "docs": {
        "tags": [],
        "text": "The `referenceElement` to position the component according to its \"placement\" value. Setting to the `HTMLElement` is preferred so the component does not need to query the DOM for the `referenceElement`. However, a string ID of the reference element can be used."
      },
