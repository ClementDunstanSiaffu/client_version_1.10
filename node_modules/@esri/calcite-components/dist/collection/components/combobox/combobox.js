...
export class Combobox {
  ...
  renderPopperContainer() {
    ...
    return (h("div", { "aria-hidden": "true", class: { "popper-container": true, "popper-container--active": open || active }, ref: setMenuEl },
      h("div", { class: classes, onTransitionEnd: this.transitionEnd, ref: setListContainerEl },
        h("ul", { class: { list: true, "list--hide": !(open || active) } },
          h("slot", null)))));
  }
  renderIconStart() {
    var _a;
    ...
    return (selectionMode === "single" &&
      needsIcon &&
      ((selectedItem === null || selectedItem === void 0 ? void 0 : selectedItem.icon) || placeholderIcon) && (h("span", { class: "icon-start" },
      h("calcite-icon", { class: "selected-icon", icon: (_a = selectedItem === null || selectedItem === void 0 ? void 0 : selectedItem.icon) !== null && _a !== void 0 ? _a : placeholderIcon, scale: "s" }))));
  }
  renderIconEnd() {
    const { active, open } = this;
    return (h("span", { class: "icon-end" },
      h("calcite-icon", { icon: active || open ? "chevron-up" : "chevron-down", scale: "s" })));
  }
  render() {
    const { active, guid, label, open } = this;
    const single = this.selectionMode === "single";
    return (h(Host, { onKeyDown: this.keydownHandler },
      h("div", { "aria-autocomplete": "list", "aria-expanded": toAriaBoolean(open || active), "aria-haspopup": "listbox", "aria-labelledby": `${labelUidPrefix}${guid}`, "aria-owns": `${listboxUidPrefix}${guid}`, class: {
          wrapper: true,
  ...
  static get properties() { return {
    "active": {
      ...
      "docs": {
        ...
        "text": "When true, opens the combobox"
      },
      "attribute": "active",
      "reflect": true,
      "defaultValue": "false"
    ...
    "placeholderIcon": {
      ...
      "docs": {
        "tags": [],
        "text": "Placeholder icon for input"
      },
  ...
  static get events() { return [{
      ...
      "complexType": {
        "original": "{ el: HTMLCalciteComboboxElement }",
        "resolved": "{ el: HTMLCalciteComboboxElement; }",
        "references": {
