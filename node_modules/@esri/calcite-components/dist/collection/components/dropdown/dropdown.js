...
export class Dropdown {
  ...
  render() {
    ...
    return (h(Host, null,
      h("div", { class: "calcite-dropdown-trigger-container", onClick: this.openCalciteDropdown, onKeyDown: this.keyDownHandler, ref: this.setReferenceEl },
        h("slot", { "aria-expanded": toAriaBoolean(active || open), "aria-haspopup": "true", name: SLOTS.dropdownTrigger, onSlotchange: this.updateTriggers })),
      h("div", { "aria-hidden": toAriaBoolean(!(active || open)), class: "calcite-dropdown-wrapper", ref: this.setMenuEl },
        h("div", { class: {
            ["calcite-dropdown-content"]: true,
            [PopperCSS.animation]: true,
            [PopperCSS.animationActive]: active || open
          }, onTransitionEnd: this.transitionEnd, ref: this.setScrollerEl },
          h("div", { hidden: !(open || active) },
            h("slot", { onSlotchange: this.updateGroups }))))));
  }
  //--------------------------------------------------------------------------
  //
  //  Public Methods
  ...
  static get events() { return [{
      ...
      "complexType": {
        "original": "{ el: HTMLCalciteDropdownElement }",
        "resolved": "{ el: HTMLCalciteDropdownElement; }",
        "references": {
          "HTMLCalciteDropdownElement": {
            "location": "global"
          }
        }
      }
