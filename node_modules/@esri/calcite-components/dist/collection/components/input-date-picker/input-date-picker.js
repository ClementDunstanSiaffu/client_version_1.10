...
export class InputDatePicker {
    ...
    return (h(Host, { onBlur: this.deactivate, onKeyDown: this.keyDownHandler, onKeyUp: this.keyUpHandler, role: "application" },
      this.localeData && (h("div", { "aria-expanded": toAriaBoolean(this.active), class: "input-container", role: "application" },
        h("div", { class: "input-wrapper", ref: this.setStartWrapper },
          h("calcite-input", { class: `input ${this.layout === "vertical" && this.range ? `no-bottom-border` : ``}`, disabled: disabled, icon: "calendar", label: getLabelText(this), "number-button-type": "none", onCalciteInputInput: this.inputInput, onCalciteInternalInputBlur: this.inputBlur, onCalciteInternalInputFocus: this.startInputFocus, placeholder: (_a = this.localeData) === null || _a === void 0 ? void 0 : _a.placeholder, readOnly: readOnly, ref: this.setStartInput, scale: this.scale, type: "text", value: formattedDate })),
  ...
  static get properties() { return {
    ...
    "readOnly": {
      ...
      "docs": {
        ...
        "text": "When true, still focusable but controls are gone and the value cannot be modified."
      },
      "attribute": "read-only",
      "reflect": false,
      "defaultValue": "false"
  ...
  static get events() { return [{
      ...
      "method": "calciteInternalInputDatePickerOpen",
      "name": "calciteInternalInputDatePickerOpen",
      "bubbles": true,
      "cancelable": true,
      "composed": true,
      "docs": {
      ...
      "method": "calciteInternalInputDatePickerClose",
      "name": "calciteInternalInputDatePickerClose",
      "bubbles": true,
      "cancelable": true,
      "composed": true,
      "docs": {
