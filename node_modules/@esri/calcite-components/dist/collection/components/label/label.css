...
*
* @prop --calcite-label-margin-bottom: The bottom margin of `calcite-label`.
*/
:host {
  display: inline;
}
...
:host(:not([disable-spacing])[scale=s]) .container {
  margin-bottom: var(--calcite-label-margin-bottom, 0.5rem);
}
...
:host(:not([disable-spacing])[scale=m]) .container {
  margin-bottom: var(--calcite-label-margin-bottom, 0.75rem);
}
...
:host(:not([disable-spacing])[scale=l]) .container {
  margin-bottom: var(--calcite-label-margin-bottom, 1rem);
}
