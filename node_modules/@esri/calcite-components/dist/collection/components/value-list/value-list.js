...
export class ValueList {
  ...
  static get properties() { return {
    ...
    "intlDragHandleActive": {
      ...
      "docs": {
        "tags": [],
        "text": "When \"drag-enabled\" is true and active, specifies accessible context to the component.\n\nUse ${position} of ${total} as placeholder for displaying indices and ${item.label} as placeholder for displaying label of `calcite-value-list-item`."
      },
    ...
    "intlDragHandleChange": {
      ...
      "docs": {
        "tags": [],
        "text": "When \"drag-enabled\" is true and active, specifies accessible context to the `calcite-value-list-item`'s new position.\n\nUse ${position} of ${total} as placeholder for displaying indices and ${item.label} as placeholder for displaying label of `calcite-value-list-item`."
      },
    ...
    "intlDragHandleCommit": {
      ...
      "docs": {
        "tags": [],
        "text": "When \"drag-enabled\" is true and active, specifies accessible context to the `calcite-value-list-item`'s current position after commit.\n\nUse ${position} of ${total} as placeholder for displaying indices and ${item.label} as placeholder for displaying label of `calcite-value-list-item`."
      },
