...
export class PickListItem {
  ...
  render() {
    ...
    return (h(Fragment, null,
      ...
      h("label", { "aria-label": label, class: CSS.label, onClick: this.pickListClickHandler, onKeyDown: this.pickListKeyDownHandler, ref: (focusEl) => (this.focusEl = focusEl), tabIndex: 0 },
        h("div", { "aria-checked": toAriaBoolean(this.selected), class: CSS.textContainer, role: "menuitemcheckbox" },
  ...
  static get properties() { return {
    ...
    "intlRemove": {
      ...
      "docs": {
        ...
        "text": "Accessible name for the component's remove button. Only applicable if removable is \"true\"."
      },
  ...
  static get events() { return [{
      ...
      "docs": {
        ...
        "text": "Emits when the the component's label, description, value, or metadata properties are modified."
      },
      "complexType": {
        "original": "void",
        "resolved": "void",
      ...
      "docs": {
        ...
        "text": "Emits when the the component's value property is modified."
      },
      "complexType": {
        "original": "{\n    oldValue: any;\n    newValue: any;\n  }",
