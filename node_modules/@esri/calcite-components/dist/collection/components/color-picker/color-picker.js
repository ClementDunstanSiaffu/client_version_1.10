...
export class ColorPicker {
    ...
    return (h("div", { class: CSS.container },
      h("div", { class: CSS.colorFieldAndSliderWrap },
        h("canvas", { class: {
          ...
          }, onPointerDown: this.handleColorFieldAndSliderPointerDown, onPointerEnter: this.handleColorFieldAndSliderPointerEnterOrMove, onPointerLeave: this.handleColorFieldAndSliderPointerLeave, onPointerMove: this.handleColorFieldAndSliderPointerEnterOrMove, ref: this.initColorFieldAndSlider }),
      ...
      hideHex && hideChannels ? null : (h("div", { class: {
        ...
        hideHex ? null : (h("div", { class: CSS.hexOptions },
          ...
          h("calcite-color-picker-hex-input", { allowEmpty: allowEmpty, class: CSS.control, numberingSystem: this.numberingSystem, onCalciteColorPickerHexInputChange: this.handleHexInputChange, scale: hexInputScale, value: selectedColorInHex }))),
  ...
  static get properties() { return {
    ...
    "numberingSystem": {
      ...
      "docs": {
        "tags": [],
        "text": "standard UniCode numeral system tag for localization"
      },
