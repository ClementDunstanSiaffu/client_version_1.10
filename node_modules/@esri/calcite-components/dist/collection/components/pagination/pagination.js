 ...
 * v1.0.0-beta.86
 */
import { Component, Element, Event, h, Prop, Method, Fragment, State } from "@stencil/core";
  ...
  render() {
    ...
    return (h(Fragment, null,
      h("button", { "aria-label": this.textLabelPrevious, class: {
        ...
        h("calcite-icon", { flipRtl: true, icon: "chevronLeft", scale: "s" })),
      ...
      h("button", { "aria-label": this.textLabelNext, class: {
        ...
        h("calcite-icon", { flipRtl: true, icon: "chevronRight", scale: "s" }))));
  }
