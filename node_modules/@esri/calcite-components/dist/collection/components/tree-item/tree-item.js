...
export class TreeItem {
  ...
  render() {
    ...
    return (h(Host, { "aria-expanded": this.hasChildren ? toAriaBoolean(this.expanded) : undefined, "aria-hidden": toAriaBoolean(hidden), "aria-selected": this.selected ? "true" : showCheckmark ? "false" : undefined, "calcite-hydrated-hidden": hidden, role: "treeitem", tabindex: this.parentExpanded || this.depth === 1 ? "0" : "-1" },
      h("div", { class: {
    ...
    "inputEnabled": {
      ...
      "docs": {
        "tags": [{
            ...
            "name": "deprecated",
            "text": "Use \"ancestors\" selection-mode on parent for checkbox input."
          }],
