...
export class Card {
  ...
  render() {
    ...
    return (h("div", { class: { "calcite-card-container": true, inline: thumbnailInline } },
      ...
      h("section", { "aria-busy": toAriaBoolean(this.loading), class: { [CSS.container]: true } },
  ...
  renderThumbnail() {
    return getSlotted(this.el, SLOTS.thumbnail) ? (h("section", { class: CSS.thumbnailWrapper },
