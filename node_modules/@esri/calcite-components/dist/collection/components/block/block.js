...
export class Block {
  ...
  renderTitle() {
    ...
    return heading || summary || description ? (h("div", { class: CSS.title },
      h(Heading, { class: CSS.heading, level: headingLevel || HEADING_LEVEL }, heading),
      summary || description ? (h("div", { class: CSS.description }, summary || description)) : null)) : null;
  }
  render() {
    ...
    return (h(Host, null,
      h("article", { "aria-busy": toAriaBoolean(loading), class: {
        ...
        headerNode,
        h("section", { "aria-expanded": toAriaBoolean(open), "aria-labelledby": buttonId, class: {
            content: true,
