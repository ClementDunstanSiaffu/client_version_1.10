...
export class ActionMenu {
  ...
  renderMenuButton() {
    ...
    const menuButtonSlot = (h("slot", { name: SLOTS.trigger },
      h("calcite-action", { class: CSS.defaultTrigger, icon: ICONS.menu, ref: this.setDefaultMenuButtonEl, scale: scale, text: label, textEnabled: expanded })));
  ...
  static get properties() { return {
    ...
    "overlayPositioning": {
      ...
      "docs": {
        "tags": [],
        "text": "Determines the type of positioning to use for the overlaid content. If your element is in a fixed container, use the \"fixed\" value."
      },
