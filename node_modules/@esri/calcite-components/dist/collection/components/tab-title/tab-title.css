...
:host([bordered][active][position=bottom]) {
  box-shadow: inset 0 2px 0 var(--calcite-ui-foreground-1);
}
...
:host([bordered][position=bottom]) a {
  border-top-style: unset;
}
...
@media (forced-colors: active) {
  ...
  :host([bordered][position=below][active]) a {
    border-top-style: none;
  }

  :host([bordered][position=bottom][active]) a {
    border-top-style: none;
  }
}