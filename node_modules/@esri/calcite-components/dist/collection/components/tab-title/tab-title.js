...
export class TabTitle {
  ...
  render() {
    ...
    return (h(Host, { "aria-controls": this.controls, "aria-expanded": toAriaBoolean(this.active), id: id, role: "tab" },
      h("a", { class: {
          container: true,
  ...
  static get events() { return [{
      ...
      "docs": {
        ...
        "text": "Fires when a specific tab is activated. Emits the \"tab\" property or the index position."
      },
      "complexType": {
