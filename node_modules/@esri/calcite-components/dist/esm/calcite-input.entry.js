...
const Input = class {
  constructor(hostRef) {
    ...
    this.calciteInternalInputFocus = createEvent(this, "calciteInternalInputFocus", 7);
    this.calciteInternalInputBlur = createEvent(this, "calciteInternalInputBlur", 7);
    ...
    this.setValue = ({ committing = false, nativeEvent, origin, previousValue, value }) => {
      const previousLocalizedValue = this.type === "number"
        ? localizeNumberString(this.previousValue, this.locale, this.groupSeparator, this.numberingSystem)
        : "";
