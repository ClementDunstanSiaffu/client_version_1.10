...
import { T as TEXT, c as getDaysDiff, d as dateToISO, a as dateFromISO, b as dateFromRange, g as getLocaleData, H as HEADING_LEVEL, s as sameDate, i as inRange, e as getOrder, n as nextMonth, f as prevMonth, l as localizeNumber, h as parseNumber } from './resources-3157143b.js';
import { a as getElementDir, C as CSS_UTILITY } from './dom-6c1f7204.js';
import { u as updateHostInteraction } from './interactive-2a03c362.js';
import { H as Heading } from './Heading-5ccb3b17.js';
import './locale-98144f51.js';
import './key-1219c482.js';
...
const DatePickerDay = class {
  constructor(hostRef) {
    ...
    this.calciteInternalDayHover = createEvent(this, "calciteInternalDayHover", 7);
...
const DatePickerMonth = class {
  constructor(hostRef) {
    ...
    this.calciteInternalDatePickerHover = createEvent(this, "calciteInternalDatePickerHover", 7);
    this.calciteDatePickerActiveDateChange = createEvent(this, "calciteDatePickerActiveDateChange", 7);
    this.calciteInternalDatePickerMouseOut = createEvent(this, "calciteInternalDatePickerMouseOut", 7);
  ...
  renderDateDay(active, day, date, currentMonth, ref) {
    ...
    return (h("calcite-date-picker-day", { active: active, class: {
      ...
      }, currentMonth: currentMonth, day: day, disabled: !inRange(date, this.min, this.max), endOfRange: this.isEndOfRange(date), highlighted: this.betweenSelectedRange(date), key: date.toDateString(), localeData: this.localeData, onCalciteDaySelect: this.daySelect, onCalciteInternalDayHover: this.dayHover, range: !!this.startDate && !!this.endDate && !sameDate(this.startDate, this.endDate), rangeHover: this.isRangeHover(date), ref: (el) => {
...
const DatePickerMonthHeader = class {
  constructor(hostRef) {
     ...
     */
    this.onYearKey = (e) => {
      const localizedYear = this.parseCalendarYear(e.target.value);
      switch (e.key) {
        case "ArrowDown":
          e.preventDefault();
  ...
  setYear({ localizedYear, commit = true, offset = 0 }) {
    ...
    if (commit) {
      yearInput.value = this.formatCalendarYear((inRangeDate || activeDate).getFullYear().toString());
    }
  }
  get el() { return getElement(this); }
  static get watchers() { return {
