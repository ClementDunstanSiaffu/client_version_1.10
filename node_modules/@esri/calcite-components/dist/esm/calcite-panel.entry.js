 ...
 * v1.0.0-beta.86
 */
import { r as registerInstance, c as createEvent, h, F as Fragment, g as getElement } from './index-dfcf10d7.js';
import { a as getElementDir, g as getSlotted, t as toAriaBoolean } from './dom-6c1f7204.js';
import { H as Heading } from './Heading-5ccb3b17.js';
import { S as SLOTS$1 } from './resources-7198828a.js';
...
const Panel = class {
  ...
  renderHeaderContent() {
    ...
    return headingNode || descriptionNode ? (h("div", { class: CSS.headerContent, key: "header-content" }, headingNode, descriptionNode)) : null;
  }
  /**
  ...
  render() {
    ...
    const panelNode = (h("article", { "aria-busy": toAriaBoolean(loading), class: CSS.container, hidden: (closable || dismissible) && (closed || dismissed), onKeyDown: panelKeyDownHandler, ref: this.setContainerRef, tabIndex: closable || dismissible ? 0 : -1 }, this.renderHeaderNode(), this.renderContent(), this.renderFooterNode()));
