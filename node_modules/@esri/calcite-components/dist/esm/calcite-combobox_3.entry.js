...
import { a as isSymbol, S as Symbol, d as debounce } from './debounce-bef6fc2c.js';
import { i as isArray, f as forIn } from './forIn-566610cc.js';
import { f as filterComputedPlacements, u as updatePopper, c as createPopper, d as defaultMenuPlacement, p as popperMenuComputedPlacements, C as CSS$2 } from './popper-f38ba1ab.js';
import { g as guid } from './guid-9ee41ac6.js';
import { n as nodeListToArray, t as toAriaBoolean, d as getElementProp, g as getSlotted } from './dom-6c1f7204.js';
import { c as connectLabel, d as disconnectLabel, g as getLabelText } from './label-b30a7cde.js';
import { s as submitForm, c as connectForm, a as afterConnectDefaultValueSet, d as disconnectForm, H as HiddenFormInputSlot } from './form-115e3241.js';
import { c as createObserver } from './observers-fa0db945.js';
import { u as updateHostInteraction } from './interactive-2a03c362.js';
import { c as connectConditionalSlotComponent, d as disconnectConditionalSlotComponent } from './conditionalSlot-13c69fa9.js';
...
const filter = (data, value) => {
  ...
  const find = (input, RE) => {
    var _a, _b;
    if (((_a = input) === null || _a === void 0 ? void 0 : _a.constant) || ((_b = input) === null || _b === void 0 ? void 0 : _b.filterDisabled)) {
      return true;
    }
    let found = false;
    forIn(input, (val) => {
...
const Combobox = class {
  constructor(hostRef) {
    ...
    this.calciteComboboxBeforeClose = createEvent(this, "calciteComboboxBeforeClose", 7);
    this.calciteComboboxClose = createEvent(this, "calciteComboboxClose", 7);
    this.calciteComboboxBeforeOpen = createEvent(this, "calciteComboboxBeforeOpen", 7);
  ...
  renderInput() {
    const { guid, active, disabled, placeholder, selectionMode, needsIcon, selectedItems, open } = this;
  ...
  renderPopperContainer() {
    ...
    const classes = {
      ...
      [CSS$2.animationActive]: open || active
    };
    return (h("div", { "aria-hidden": "true", class: { "popper-container": true, "popper-container--active": open || active }, ref: setMenuEl }, h("div", { class: classes, onTransitionEnd: this.transitionEnd, ref: setListContainerEl }, h("ul", { class: { list: true, "list--hide": !(open || active) } }, h("slot", null)))));
  }
  renderIconStart() {
    var _a;
    ...
    return (selectionMode === "single" &&
      needsIcon &&
      ((selectedItem === null || selectedItem === void 0 ? void 0 : selectedItem.icon) || placeholderIcon) && (h("span", { class: "icon-start" }, h("calcite-icon", { class: "selected-icon", icon: (_a = selectedItem === null || selectedItem === void 0 ? void 0 : selectedItem.icon) !== null && _a !== void 0 ? _a : placeholderIcon, scale: "s" }))));
  }
  renderIconEnd() {
  ...
  render() {
    ...
    return (h(Host, { onKeyDown: this.keydownHandler }, h("div", { "aria-autocomplete": "list", "aria-expanded": toAriaBoolean(open || active), "aria-haspopup": "listbox", "aria-labelledby": `${labelUidPrefix}${guid}`, "aria-owns": `${listboxUidPrefix}${guid}`, class: {
        wrapper: true,
