 ...
 * v1.0.0-beta.86
 */
import { r as registerInstance, c as createEvent, h, H as Host, g as getElement } from './index-dfcf10d7.js';
import { T as TEXT$1, g as getSlotted, s as setRequestedIcon, d as getElementProp, a as getElementDir, C as CSS_UTILITY } from './dom-6c1f7204.js';
import { c as connectLabel, d as disconnectLabel, g as getLabelText } from './label-b30a7cde.js';
import { s as submitForm, c as connectForm, d as disconnectForm, H as HiddenFormInputSlot } from './form-115e3241.js';
import { d as delocalizeNumberString, i as isValidNumber, p as parseNumberString, g as getDecimalSeparator, l as localizeNumberString, s as sanitizeNumberString } from './locale-98144f51.js';
import { n as numberKeys } from './key-1219c482.js';
import { d as decimalPlaces } from './math-7409ae0d.js';
import { c as createObserver } from './observers-fa0db945.js';
import { u as updateHostInteraction } from './interactive-2a03c362.js';
import './guid-9ee41ac6.js';
...
const InputNumber = class {
  constructor(hostRef) {
    ...
    this.calciteInternalInputNumberFocus = createEvent(this, "calciteInternalInputNumberFocus", 7);
    this.calciteInternalInputNumberBlur = createEvent(this, "calciteInternalInputNumberBlur", 7);
    this.calciteInputNumberInput = createEvent(this, "calciteInputNumberInput", 7);
    this.calciteInputNumberChange = createEvent(this, "calciteInputNumberChange", 7);
    //--------------------------------------------------------------------------
    //
    //  Properties
    //
    ...
    this.setNumberValue = ({ committing = false, nativeEvent, origin, previousValue, value }) => {
      const previousLocalizedValue = localizeNumberString(this.previousValue, this.locale, this.groupSeparator, this.numberingSystem);
      ...
      const newValue = value && !sanitizedValue
        ? isValidNumber(this.previousValue)
          ...
          : ""
        : sanitizedValue;
      const newLocalizedValue = localizeNumberString(newValue, this.locale, this.groupSeparator, this.numberingSystem);
