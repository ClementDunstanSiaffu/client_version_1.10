 ...
 * v1.0.0-beta.86
 */
import { r as registerInstance, c as createEvent, f as forceUpdate, h, H as Host, g as getElement } from './index-dfcf10d7.js';
import { a as defaultOffsetDistance, f as filterComputedPlacements, u as updatePopper, c as createPopper, C as CSS$1 } from './popper-f38ba1ab.js';
import { g as guid } from './guid-9ee41ac6.js';
import { t as toAriaBoolean, q as queryElementRoots } from './dom-6c1f7204.js';
...
const Popover = class {
  ...
  renderCloseButton() {
    ...
    return closable || dismissible || closeButton ? (h("div", { class: CSS.closeButtonContainer }, h("calcite-action", { class: CSS.closeButton, onClick: this.hide, ref: (closeButtonEl) => (this.closeButtonEl = closeButtonEl), scale: heading ? "s" : "m", text: intlClose }, h("calcite-icon", { icon: "x", scale: heading ? "s" : "m" })))) : null;
  }
  renderHeader() {
