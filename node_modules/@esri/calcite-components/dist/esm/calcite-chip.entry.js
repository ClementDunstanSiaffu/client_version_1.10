...
import { g as getSlotted } from './dom-6c1f7204.js';
...
const Chip = class {
  ...
  render() {
    ...
    return (h("div", { class: "container" }, this.renderChipImage(), this.icon ? iconEl : null, h("span", { class: CSS.title, id: this.guid }, h("slot", null)), this.closable || this.dismissible ? closeButton : null));
  }
