...
import { t as toAriaBoolean, f as focusElement, d as getElementProp } from './dom-6c1f7204.js';
import { d as defaultMenuPlacement, f as filterComputedPlacements, C as CSS$2, u as updatePopper, c as createPopper, p as popperMenuComputedPlacements } from './popper-f38ba1ab.js';
...
const Dropdown = class {
  constructor(hostRef) {
    ...
    this.calciteDropdownBeforeOpen = createEvent(this, "calciteDropdownBeforeOpen", 7);
    this.calciteDropdownOpen = createEvent(this, "calciteDropdownOpen", 7);
    this.calciteDropdownBeforeClose = createEvent(this, "calciteDropdownBeforeClose", 7);
  ...
  render() {
    ...
    return (h(Host, null, h("div", { class: "calcite-dropdown-trigger-container", onClick: this.openCalciteDropdown, onKeyDown: this.keyDownHandler, ref: this.setReferenceEl }, h("slot", { "aria-expanded": toAriaBoolean(active || open), "aria-haspopup": "true", name: SLOTS.dropdownTrigger, onSlotchange: this.updateTriggers })), h("div", { "aria-hidden": toAriaBoolean(!(active || open)), class: "calcite-dropdown-wrapper", ref: this.setMenuEl }, h("div", { class: {
        ["calcite-dropdown-content"]: true,
        [CSS$2.animation]: true,
        [CSS$2.animationActive]: active || open
      }, onTransitionEnd: this.transitionEnd, ref: this.setScrollerEl }, h("div", { hidden: !(open || active) }, h("slot", { onSlotchange: this.updateGroups }))))));
  }
  //--------------------------------------------------------------------------
  //
  //  Public Methods
...
const DropdownGroup = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.calciteInternalDropdownItemChange = createEvent(this, "calciteInternalDropdownItemChange", 7);
    /**
...
const DropdownItem = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.calciteInternalDropdownItemSelect = createEvent(this, "calciteInternalDropdownItemSelect", 7);
    this.calciteInternalDropdownItemKeyEvent = createEvent(this, "calciteInternalDropdownItemKeyEvent", 7);
    this.calciteInternalDropdownCloseRequest = createEvent(this, "calciteInternalDropdownCloseRequest", 7);
    //--------------------------------------------------------------------------
    //
    //  Public Properties
    //
