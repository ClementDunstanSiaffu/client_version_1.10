...
import { C as CSS, I as ICONS, S as SLOTS } from './resources-7198828a.js';
import { g as getSlotted, t as toAriaBoolean, f as focusElement } from './dom-6c1f7204.js';
import { g as getRoundRobinIndex } from './array-48f23287.js';
...
const ActionMenu = class {
  ...
  renderMenuButton() {
    ...
    const menuButtonSlot = (h("slot", { name: SLOTS.trigger }, h("calcite-action", { class: CSS.defaultTrigger, icon: ICONS.menu, ref: this.setDefaultMenuButtonEl, scale: scale, text: label, textEnabled: expanded })));
