 ...
 * v1.0.0-beta.86
 */
import { r as registerInstance, c as createEvent, h, g as getElement, H as Host } from './index-dfcf10d7.js';
import { d as getElementProp, a as getElementDir, t as toAriaBoolean, C as CSS_UTILITY } from './dom-6c1f7204.js';
...
const Accordion = class {
  constructor(hostRef) {
    ...
    this.calciteInternalAccordionChange = createEvent(this, "calciteInternalAccordionChange", 7);
    //--------------------------------------------------------------------------
    //
    //  Public Properties
    //
...
const AccordionItem = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.calciteInternalAccordionItemKeyEvent = createEvent(this, "calciteInternalAccordionItemKeyEvent", 7);
    this.calciteInternalAccordionItemSelect = createEvent(this, "calciteInternalAccordionItemSelect", 7);
    this.calciteInternalAccordionItemClose = createEvent(this, "calciteInternalAccordionItemClose", 7);
    this.calciteInternalAccordionItemRegister = createEvent(this, "calciteInternalAccordionItemRegister", 7);
    //--------------------------------------------------------------------------
    //
    //  Public Properties
    //
  ...
  render() {
    ...
    return (h(Host, { tabindex: "0" }, h("div", { class: {
      ...
      } }, h("div", { "aria-controls": regionId, "aria-expanded": toAriaBoolean(this.active), class: { "accordion-item-header": true, [CSS_UTILITY.rtl]: dir === "rtl" }, id: buttonId, onClick: this.itemHeaderClickHandler, role: "button" }, this.icon ? iconEl : null, h("div", { class: "accordion-item-header-text" }, h("span", { class: "accordion-item-heading" }, this.heading || this.itemTitle), this.itemSubtitle ? (h("span", { class: "accordion-item-description" }, this.description || this.itemSubtitle)) : null), h("calcite-icon", { class: "accordion-item-expand-icon", icon: this.iconType === "chevron"
        ? "chevronDown"
        : this.iconType === "caret"
          ? "caretDown"
          : this.expanded || this.active
            ? "minus"
            : "plus", scale: "s" })), h("div", { "aria-expanded": toAriaBoolean(this.expanded || this.active), "aria-labelledby": buttonId, class: "accordion-item-content", id: regionId, role: "region" }, h("slot", null)))));
  }
  //--------------------------------------------------------------------------
  //
  //  Event Listeners
