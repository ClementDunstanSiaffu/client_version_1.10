...
declare module "preact/src/jsx" {
  namespace JSXInternal {
    interface IntrinsicElements {
      ...
      "calcite-accordion-item": Omit<JSX.CalciteAccordionItem, "onCalciteInternalAccordionItemKeyEvent" | "onCalciteInternalAccordionItemSelect" | "onCalciteInternalAccordionItemClose" | "onCalciteInternalAccordionItemRegister"> & JSXInternal.HTMLAttributes<HTMLCalciteAccordionItemElement> & {
      ...
      "calcite-date-picker-month": Omit<JSX.CalciteDatePickerMonth, "onCalciteDatePickerSelect" | "onCalciteInternalDatePickerHover" | "onCalciteDatePickerActiveDateChange" | "onCalciteInternalDatePickerMouseOut"> & JSXInternal.HTMLAttributes<HTMLCalciteDatePickerMonthElement> & {
      ...
      "calcite-dropdown": Omit<JSX.CalciteDropdown, "onCalciteDropdownSelect" | "onCalciteDropdownBeforeOpen" | "onCalciteDropdownOpen" | "onCalciteDropdownBeforeClose" | "onCalciteDropdownClose"> & JSXInternal.HTMLAttributes<HTMLCalciteDropdownElement> & {
      ...
      "calcite-dropdown-item": Omit<JSX.CalciteDropdownItem, "onCalciteInternalDropdownItemSelect" | "onCalciteInternalDropdownItemKeyEvent" | "onCalciteInternalDropdownCloseRequest"> & JSXInternal.HTMLAttributes<HTMLCalciteDropdownItemElement> & {
      ...
      "calcite-input-date-picker": Omit<JSX.CalciteInputDatePicker, "onCalciteDatePickerChange" | "onCalciteDatePickerRangeChange" | "onCalciteInputDatePickerChange" | "onCalciteInternalInputDatePickerOpen" | "onCalciteInternalInputDatePickerClose"> & JSXInternal.HTMLAttributes<HTMLCalciteInputDatePickerElement> & {
        "oncalciteDatePickerChange"?: (event: CustomEvent<any>) => void;
        "oncalciteDatePickerRangeChange"?: (event: CustomEvent<any>) => void;
        "oncalciteInputDatePickerChange"?: (event: CustomEvent<any>) => void;
        "oncalciteInternalInputDatePickerOpen"?: (event: CustomEvent<any>) => void;
        "oncalciteInternalInputDatePickerClose"?: (event: CustomEvent<any>) => void;
      }
      ...
      "calcite-panel": Omit<JSX.CalcitePanel, "onCalcitePanelDismiss" | "onCalcitePanelDismissedChange" | "onCalcitePanelScroll" | "onCalcitePanelBackClick"> & JSXInternal.HTMLAttributes<HTMLCalcitePanelElement> & {
      ...
      "calcite-radio-group-item": Omit<JSX.CalciteRadioGroupItem, "onCalciteInternalRadioGroupItemChange"> & JSXInternal.HTMLAttributes<HTMLCalciteRadioGroupItemElement> & {
      ...
      "calcite-tab-title": Omit<JSX.CalciteTabTitle, "onCalciteTabsActivate" | "onCalciteInternalTabsActivate" | "onCalciteInternalTabsFocusNext" | "onCalciteInternalTabsFocusPrevious" | "onCalciteInternalTabTitleRegister"> & JSXInternal.HTMLAttributes<HTMLCalciteTabTitleElement> & {
      ...
      "calcite-tip-manager": Omit<JSX.CalciteTipManager, "onCalciteTipManagerToggle" | "onCalciteTipManagerClose"> & JSXInternal.HTMLAttributes<HTMLCalciteTipManagerElement> & {
