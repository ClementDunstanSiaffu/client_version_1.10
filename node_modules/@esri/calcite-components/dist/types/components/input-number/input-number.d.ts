 ...
 */
export declare class InputNumber implements LabelableComponent, FormComponent, InteractiveComponent {
   ...
   * @internal
   */
  calciteInternalInputNumberFocus: EventEmitter;
  /**
   * @internal
   */
  calciteInternalInputNumberBlur: EventEmitter;
  /**
   * Fires each time a new value is typed.
   */
  calciteInputNumberInput: EventEmitter;
  /**
