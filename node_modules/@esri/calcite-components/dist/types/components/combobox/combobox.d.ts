 ...
 */
export declare class Combobox implements LabelableComponent, FormComponent, InteractiveComponent, OpenCloseComponent {
  ...
  calciteComboboxBeforeClose: EventEmitter<{
    el: HTMLCalciteComboboxElement;
  }>;
  calciteComboboxClose: EventEmitter<{
    el: HTMLCalciteComboboxElement;
  }>;
  calciteComboboxBeforeOpen: EventEmitter<{
    el: HTMLCalciteComboboxElement;
  }>;
