...
export declare class Alert {
  ...
  render(): VNode;
  calciteAlertBeforeClose: EventEmitter<{
    el: HTMLCalciteAlertElement;
  ...
  calciteAlertBeforeOpen: EventEmitter<{
    el: HTMLCalciteAlertElement;
    queue: HTMLCalciteAlertElement[];
  }>;
   ...
   * @internal
   */
  calciteInternalAlertSync: EventEmitter;
  /**
   * Fires when the component is added to DOM - used to receive initial queue.
   *
   * @internal
   */
  calciteInternalAlertRegister: EventEmitter;
